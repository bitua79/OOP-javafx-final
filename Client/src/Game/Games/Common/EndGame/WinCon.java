...
public class WinCon implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        mediaView.setMediaPlayer(WIN_PLAYER);
        PlayMedia(WIN_PLAYER);

        if (EffectVolume != 0) WIN_EFFECT.setVolume(0.2);
        WIN_EFFECT.play();
        ...
        ResponsiveLBL(label, 1, 20, 55, 37, 70);
