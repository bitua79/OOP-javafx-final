...
public class LoseCon implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        mediaView.setMediaPlayer(LOSE_PLAYER);
        PlayMedia(LOSE_PLAYER);

        if (EffectVolume != 0) LOSE_EFFECT.setVolume(0.2);
        LOSE_EFFECT.play();
        ...
        ResponsiveLBL(label, 1, 20, 60, 45, 80);
